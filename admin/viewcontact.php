...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td>".$row["username"]."</td><td>".$row["email"]."</td><td>".$row["message"]."</td><td><button class='action-btn' onclick='location.href=\"editcontact.php?id=".$row["id"]."\"'>Edit</button> <button class='action-btn' onclick='location.href=\"deletecontact.php?id=".$row["id"]."\"'>Delete</button></td></tr>";
    }
    echo "</table>";
} else {
