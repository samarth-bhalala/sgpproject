                ...
                <div class="col-2">
                    <div class="box">
                        <a href="beginner.php" class="btn">
                            <img src="/sgpproject/sgpproject/img/mbp_hp_b.jpg" alt="Beginner">
                            <h2>Beginner</h2>
                        </a>
                    </div>
                </div>
                <div class="col-3">
                    <div class="box">
                        <a href="intermediate.php" class="btn">
                            <img src="/sgpproject/sgpproject/img/mbp_hp_i.jpg" alt="Intermediate">
                            <h2>Intermediate</h2>
                        </a>
                    </div>
                </div>
                <div class="col-4">
                    <div class="box">
                        <a href="advanced.php" class="btn">
                            <img src="/sgpproject/sgpproject/img/mbp_hp_a.jpg" alt="Advanced">
                            <h2>Advanced</h2>
                        </a>
                    </div>
                </div>
